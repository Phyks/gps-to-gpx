...
function assertArgValidity(waypoints, options) {
  ...
  if (!doesExist(waypoints) || getType(waypoints) !== 'array' || !waypoints.length || waypoints.some(function (point) {
    return getType(point) !== 'object';
  })) {
 ...
 */
export default function createGpx(waypoints) {
  ...
  var settings = _Object$assign({}, defaultSettings, options);
  ...
  waypoints.forEach(function (point) {
    ...
    if ({}.hasOwnProperty.call(point, extKey)) {
      ...
      if ({}.hasOwnProperty.call(point, extKey)) {
        _Object$keys(point[extKey]).forEach(function (ext) {
